package com.opethic.hrms.HRMSNew.controllers.access_permissions;

import com.google.gson.JsonObject;
import com.opethic.hrms.HRMSNew.services.access_permissions.SystemActionMappingService;
...
public class SystemActionMappingController {
  ...
  /*  @GetMapping(path = "/get_systems_all_permissions")
    ...
    public Object getMappings() {
        JsonObject res = service.getMappings();
        return res.toString();
    }
